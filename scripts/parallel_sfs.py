...
output_filename = os.path.join(file_dir, "sfs", base_filename + '_' + num_samples_str + '.sfs.tsv')


#num_samples_str =str(num_to_sample)
#output_filename = os.path.splitext(input_file)[0] + '_' + num_samples_str + '.sfs.tsv'
#output_path = os.path.join(output_dir, output_filename)
#print(output_path) wrong
...
print(output_filename)
sfs_df.to_csv(output_filename, sep='\t', index_label='allele counts')
