...
# script to find number of re-sampled individuals
...
for sd_value in sd_range:
    ...
    for it in range(niter):
        ...
        # find number of resampled individuals
...
sampling_data = {"sampling_width":sd_range,
                 "realised_width":widths,
                 "num_resampled":resampled}
sampling_df = pd.DataFrame(sampling_data)

# Save SFS DataFrame to file
print("Saving file to")
print(output)
sampling_df.to_csv(output, sep='\t', index=False, na_rep="NA")
